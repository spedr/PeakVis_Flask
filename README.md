...
To install the Peakvis project, you can either download the compressed folder or clone the reposiory.
...
- A video file shownig the event you want to analyze
...
To insert your video file into the project, go to the **\Peakvis-master\static\DATA\videos** path and insert your file in the folder.
...
- Click into the Submit button and wait. The application must generate all the visualization elements
